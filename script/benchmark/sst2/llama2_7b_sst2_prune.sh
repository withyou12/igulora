...
nohup python -u iglora/run_pruning_sft.py \
    --seed 200 \
    ...
    --num_train_epochs 5 \
    --warmup_steps 100 \
    --output_dir experiments/outputs/iglora_llama7b_sst2_200 \
    --do_train true\
    --eval_steps 100 \
    ...
    --lora_rank 32 \
    --start_prune_steps 100 \
    --end_prune_steps 6000 \
    --prune_every_steps 50 \
    --target_total_rank 5234 \
